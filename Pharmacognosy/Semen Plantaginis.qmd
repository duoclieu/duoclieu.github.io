---
title: Semen Plantaginis
subtitle: Mã Đề - Hạt
description: "Dược liệu Mã Đề - Hạt từ Hạt của loài *Plantago major* thuộc Họ Plantaginaceae."
...
listing:
  - id: listing-soibot
    ...
    contents: "Semen Plantaginis/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Semen Plantaginis/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-DDHK
    ...
    contents: "Semen Plantaginis/DDHK/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Semen Plantaginis/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
...
<iframe src="Semen Plantaginis/map_distribution.html" width="100%" height="600" style="border:none;"></iframe>
