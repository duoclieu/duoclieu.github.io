---
title: Spica Prunellae
subtitle: Hạ Khô Thảo - Cụm Quả
description: "Dược liệu Hạ Khô Thảo - Cụm Quả từ Cụm Quả của loài *Prunella vulgaris* thuộc Họ Lamiaceae."
author: "TS. Hoàng Lê Sơn"
toc: true
image: https://images.ala.org.au/image/proxyImageThumbnailLarge?imageId=12f7d263-c64c-4373-ad29-4e2df4da87a9
...
listing:
  - id: listing-soibot
    ...
    contents: "Spica Prunellae/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Spica Prunellae/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Spica Prunellae/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
...
Trong dược điển Việt nam, loài *Prunella vulgaris* được sử dụng làm dược liệu.

            
::: {.callout-note title = "Phân loại thực vật của *Prunella vulgaris*"}
...
<iframe src="Spica Prunellae/map_distribution.html" width="100%" height="600" style="border:none;"></iframe>
