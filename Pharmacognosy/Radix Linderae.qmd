---
title: Radix Linderae
subtitle: Ô Dược - Rễ
description: "Dược liệu Ô Dược - Rễ từ Rễ của loài *Lindera aggregata* thuộc Họ Lamiaceae."
...
listing:
  - id: listing-soibot
    ...
    contents: "Radix Linderae/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Radix Linderae/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Radix Linderae/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
categories: Lamiaceae
tags: [Lindera aggregata, Lamiaceae]
---
...
Trong dược điển Việt nam, loài *Lindera aggregata* được sử dụng làm dược liệu. 
...
**Công năng chủ trị:** Tân, ôn. Vào các kinh phế, tỳ, thận, bàng quang.
