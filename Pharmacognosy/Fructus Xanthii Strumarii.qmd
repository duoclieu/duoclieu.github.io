---
title: Fructus Xanthii Strumarii
subtitle: Ké Đầu Ngựa - Quả
description: "Dược liệu Ké Đầu Ngựa - Quả từ Quả của loài *Xanthium strumarium* thuộc Họ Asteraceae."
...
listing:
  - id: listing-soibot
    ...
    contents: "Fructus Xanthii Strumarii/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Fructus Xanthii Strumarii/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-DDHK
    ...
    contents: "Fructus Xanthii Strumarii/DDHK/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Fructus Xanthii Strumarii/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
...
Trong dược điển Việt nam, loài *Xanthium strumarium* được sử dụng làm dược liệu.

            
::: {.callout-note title = "Phân loại thực vật của *Xanthium strumarium*"}
...
<iframe src="Fructus Xanthii Strumarii/map_distribution.html" width="100%" height="600" style="border:none;"></iframe>
