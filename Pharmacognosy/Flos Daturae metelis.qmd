---
title: Flos Daturae metelis
subtitle: Cà Độc Dược - Hoa
description: "Dược liệu Cà Độc Dược - Hoa từ Hoa của loài *Datura metel* thuộc Họ Solanaceae."
...
listing:
  - id: listing-soibot
    ...
    contents: "Flos Daturae metelis/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Flos Daturae metelis/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-DDHK
    ...
    contents: "Flos Daturae metelis/DDHK/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Flos Daturae metelis/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
...
<iframe src="Flos Daturae metelis/map_distribution.html" width="100%" height="600" style="border:none;"></iframe>
