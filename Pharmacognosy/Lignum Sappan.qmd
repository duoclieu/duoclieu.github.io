---
title: Lignum Sappan
subtitle: Tô Mộc - Lõi Gỗ
description: "Dược liệu Tô Mộc - Lõi Gỗ từ Lõi Gỗ của loài *Caesalpinia sappan* thuộc Họ Fabaceae."
author: "TS. Hoàng Lê Sơn"
toc: true
image: http://www.aubot.dk/specimenimages/H.Balslev12062019/IMG_0052.jpg
...
listing:
  - id: listing-soibot
    ...
    contents: "Lignum Sappan/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Lignum Sappan/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Lignum Sappan/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
categories: Fabaceae
...
Trong dược điển Việt nam, loài *Caesalpinia sappan* được sử dụng làm dược liệu.

            
::: {.callout-note title = "Phân loại thực vật của *Biancaea sappan*"}
...
<iframe src="Lignum Sappan/map_distribution.html" width="100%" height="600" style="border:none;"></iframe>
