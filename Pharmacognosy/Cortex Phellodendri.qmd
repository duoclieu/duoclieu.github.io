---
title: Cortex Phellodendri
subtitle: Hoàng Bá - Vỏ Thân
description: "Dược liệu Hoàng Bá - Vỏ Thân từ Vỏ Thân của loài *Phellodendron chinense, Phellodendron amurense* thuộc Họ Rutaceae."
author: "TS. Hoàng Lê Sơn"
toc: true
image: https://inaturalist-open-data.s3.amazonaws.com/photos/343954394/original.jpg
...
listing:
  - id: listing-soibot
    ...
    contents: "Cortex Phellodendri/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Cortex Phellodendri/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-DDHK
    ...
    contents: "Cortex Phellodendri/DDHK/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Cortex Phellodendri/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
categories: Rutaceae
...
- Dược liệu tiếng Việt: Hoàng Bá - Vỏ Thân
- Dược liệu tiếng Trung: nan (nan)
- Dược liệu tiếng Anh: nan
- Dược liệu latin thông dụng: Cortex Phellodendri
...
Dược liệu **Hoàng Bá - Vỏ Thân** từ bộ phận **Vỏ Thân** từ loài *Phellodendron chinense*.
...
::: {.callout-note title = "Phân loại thực vật của *Phellodendron chinense*"}
...
<iframe src="Cortex Phellodendri/map_distribution.html" width="100%" height="600" style="border:none;"></iframe>



            
::: {.callout-note title = "Phân loại thực vật của *Phellodendron amurense*"}
...
Theo cơ sở dữ liệu lotus, loài *Phellodendron amurense* đã phân lập và xác định được **206** hoạt chất thuộc về các nhóm Lignan glycosides, Aryltetralin lignans, Cinnamic acids and derivatives, Flavonoids, Aporphines, Steroids and steroid derivatives, Indolonaphthyridine alkaloids, Organooxygen compounds, Benzene and substituted derivatives, Quinolines and derivatives, Coumarins and derivatives, Indoles and derivatives, Isoquinolines and derivatives, Fatty Acyls, Phenols, Prenol lipids, Protoberberine alkaloids and derivatives trong bảng dưới đây.
