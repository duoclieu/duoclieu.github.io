---
title: Flos Cleistocalysis Operculati
subtitle: Vối - Nụ Hoa
description: "Dược liệu Vối - Nụ Hoa từ Nụ Hoa của loài *Cleistocalyx operculatus* thuộc Họ Lauraceae."
...
listing:
  - id: listing-soibot
    ...
    contents: "Flos Cleistocalysis Operculati/Soi_Bot/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-viphau
    template: gallery.ejs
    contents: "Flos Cleistocalysis Operculati/Vi_Phau/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-DDHK
    ...
    contents: "Flos Cleistocalysis Operculati/DDHK/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
  ...
  - id: listing-ViThuoc
    template: gallery.ejs
    contents: "Flos Cleistocalysis Operculati/Vi_Thuoc/*.*"
    sort-ui: false
    filter-ui: false
    categories: false
categories: Lauraceae
tags: [Cleistocalyx operculatus, Lauraceae]
---
...
- Dược liệu tiếng Việt: Vối - Nụ Hoa
...
Dược liệu **Vối - Nụ Hoa** từ bộ phận **Nụ Hoa** từ loài *Cleistocalyx operculatus*.
...
Trong dược điển Việt nam, loài *Cleistocalyx operculatus* được sử dụng làm dược liệu. 
...
- **Bảo quản:** Trong bao bì kín, nơi khô mát. thoáng gió, tránh nấm mốc.
...
**Công năng chủ trị:** Đắng, chát, tính hàn. Vào kinh tỳ, vị. phế, thận.
...
**Kiêng kỵ:** Tỳ vị hư hàn, ỉa chảy không dùng. 
