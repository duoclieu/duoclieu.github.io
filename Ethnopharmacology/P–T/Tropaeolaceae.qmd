...
::: {.table caption="Bảng các loài được sử dụng làm thuốc từ họ Tropaeolaceae"}
...
const data = {
  ...
  iso3_codes: ['BRA', 'RWA', 'MWI', 'CHL', 'NZL', 'MEX', 'ZAF', 'USA', 'NOR', 'SWE', 'DOM', 'PER', 'FRA', 'HKG', 'GBR', 'AUS', 'REU', 'ITA', 'GTM', 'DZA', 'MLT', 'DEU', 'UKR', 'NLD', 'ARG', 'ECU', 'CAN', 'NPL', 'RUS', 'PRT', 'ESP', 'MYS', 'BEL', 'COL', 'POL', 'CHN', 'KWT', 'IND'],
...
<div class="group-title">"Hoạt chất phổ biến trong họ"</div>\n<div class="grid-container">" <div class="molecule-box"> <canvas id="canvas_Row0" width="150" height="150"></canvas> <div class="mol-name">LTS0189449</div></div> <div class="molecule-box"> <canvas id="canvas_Row1" width="150" height="150"></canvas> <div class="mol-name">LTS0254185</div></div> <div class="molecule-box"> <canvas id="canvas_Row2" width="150" height="150"></canvas> <div class="mol-name">LTS0054338</div></div> <div class="molecule-box"> <canvas id="canvas_Row3" width="150" height="150"></canvas> <div class="mol-name">LTS0091846</div></div> <div class="molecule-box"> <canvas id="canvas_Row4" width="150" height="150"></canvas> <div class="mol-name">LTS0143901</div></div></div>
...
::: {.table caption="Bảng chi tiết các loài được làm thuốc từ họ Tropaeolaceae"}
...
{id: "canvas_Row1", smiles: "O=S(=O)(O)ON=C(Cc1ccccc1)SC1OC(CO)C(O)C(O)C1O" },
{id: "canvas_Row2", smiles: "OC[C@H]1O[C@@H](O[C@H]2[C@H](Oc3cc4c(O)cc(O)cc4[o+]c3-c3ccc(O)cc3)O[C@H](CO)[C@@H](O)[C@@H]2O)[C@H](O)[C@@H](O)[C@@H]1O" },
{id: "canvas_Row3", smiles: "O=C(O)Cc1ccccc1" },
