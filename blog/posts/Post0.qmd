---
title: "Cơ sở dữ liệu về dược liệu"
description: "Các cơ sở dữ liệu được tập trung xây dựng bao gồm: Dược liệu, Dược dân tộc học, Dược cổ truyền"
image: "../Images/quo-vadis.png"
...
::: {.callout-note title= "Vườn thực vật KEW"}
...
::: {.callout-note title= "Lotus: Cơ sở dữ liệu các hợp chất tự nhiên"}
...
::: {.callout-note title= "Dược điển Việt Nam V"}
...
::: {.callout-note title= "Những cây thuốc và vị thuốc Việt Nam- GS.TS. Đỗ Tất Lợi"}
